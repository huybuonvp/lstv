...
def main():
    ...
    scraper.export_json(streams, filename=f"streams.json")
    scraper.export_m3u(streams, filename=f"streams.m3u")
    scraper.export_monplayer_json(streams, filename=f"monplayer.json")
